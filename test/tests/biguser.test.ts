...
// disabled because the plugin "mongoose-findorcreate" makes use of things removed in mongoose 7.0
// it.skip('should create a user with [Plugin].findOrCreate', async () => {
